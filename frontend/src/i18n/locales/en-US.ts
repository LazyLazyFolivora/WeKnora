export default {
  ...
  auth: {
    ...
    casLogin: 'Sign in with CAS',
    casLoginWithProvider: 'Sign in with {provider}',
    redirectingToCAS: 'Redirecting to CAS...',
    casLoginFailed: 'CAS login failed',
    username: 'Username',
    email: 'Email',
    password: 'Password',
    confirmPassword: 'Confirm Password',
  ...
  chat: {
    ...
    pharmacyExample1: 'What are the common adverse reactions of Amoxicillin?',
    pharmacyExample2: 'Explain the concept of drug half-life and its clinical significance',
    pharmacyExample3: 'How to manage allergic reactions to cephalosporin antibiotics?',
    pharmacyExample4: 'How to adjust dosage for patients with hepatic impairment?',
    ...
    graphDataHeader: 'Found {nodes} nodes, {edges} relations',
    graphNodesLabel: 'Nodes',
    graphRelationsLabel: 'Relations',
