...
const knowledgeBaseTools = ['grep_chunks', 'knowledge_search', 'list_knowledge_chunks', 'query_knowledge_graph', 'get_document_info', 'database_query', 'neo4j_hybrid_search', 'explore_graph'];
...
const allTools = computed(() => [
  ...
  { value: 'neo4j_hybrid_search', label: t('agentEditor.tools.neo4jHybridSearch'), description: t('agentEditor.tools.neo4jHybridSearchDesc'), group: 'rag' },
  { value: 'explore_graph', label: t('agentEditor.tools.exploreGraph'), description: t('agentEditor.tools.exploreGraphDesc'), group: 'rag' },
